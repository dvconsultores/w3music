<template>
  <section id="landing" class="divcol center overflow" ref="hero">
    ...
    <img id="artist" class="floating" src="@/assets/miscellaneous/artist.svg" alt="artist">
    <img id="other" class="floating" src="@/assets/miscellaneous/other.svg" alt="other">
    <img id="fan" class="floating" src="@/assets/miscellaneous/fan.svg" alt="fan" @click="$router.push('/home')">
  </section>
</template>
